...
const Provider = ({ onLogout }) => {
  ...
  return (
    <div className="Provider">
      <NavBarNoMenu />
      <FaArrowLeft className="back-arrow3" size={30} onClick={handleLogout} />
      <Container className="mt-51">
        <Row className="justify-content-center">
          <Col xs={12} md={6}>
            <h2 className="text-center1">Bienvenido Proveedor</h2>
            {error && <p style={{ color: 'red' }}>{error}</p>}
            {success && <p style={{ color: 'green' }}>{success}</p>}
            <div className="login-box mt-5">
              <h2 className="text-center-h1">Crear Proveedor</h2>
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group controlId="formApellidoPat" className="mt-31">
                ...
                <Form.Group controlId="formApellidoMat" className="mt-31">
                ...
                <Form.Group controlId="formTelefono" className="mt-31">
                ...
                <Form.Group controlId="formEmpresa" className="mt-31">
                ...
                <Form.Group controlId="formIdUsuario" className="mt-31">
                ...
                <Button variant="outline-purple bold-text" type="submit" className="mt-41" block>
                  Crear Proveedor
                </Button>
              </Form>
            </div>
