                    ...
                    <Col xs={12} md={8}>
                        <div className='create-box'>
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group controlId="formBasicCodigoPostal" className="mt-3">
                                ...
                                <Row className="mt-3">
                                    ...
                                    <Col xs={12} md={6}>
                                        <Form.Group controlId="formBasicProveedor">
                                            <Form.Label className='bold-text'>Proveedor</Form.Label>
                                            <Form.Control
                                                type="text"
                                                value={proveedor}
                                                readOnly
                                ...
                                <Button variant="outline-purple bold-text" onClick={handleBack} className="mt-4" block>
                                    Volver al Dashboard del Proveedor
                                </Button>
                            </Form>
                        </div>
                    </Col>
