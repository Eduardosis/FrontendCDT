...
import ReporteEnvios from './components/Pages/Admin/AdminReporteEnv';
import ReporteEntrega from './components/Pages/Admin/AdminReporteEnt';
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/admin" element={userRole === '1' ? <AdminDashboard onLogout={handleLogout} /> : <Navigate to="/" />} />
                ...
                <Route path="/adminreporteent" element={userRole === '1' ? <ReporteEntrega /> : <Navigate to="/" />} />
                <Route path="/adminreporteenv" element={userRole === '1' ? <ReporteEnvios /> : <Navigate to="/" />} />
